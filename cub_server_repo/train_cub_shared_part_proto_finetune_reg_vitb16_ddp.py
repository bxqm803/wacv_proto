...
Offline NPPL augmentations may be appended. Synchronized affine/linear boxes
are supervised; non-linear variants carry invalid boxes and remain label-only.
"""
...
def main() -> None:
    ...
    rank0_print("[Run] shared part-prototype finetuning")
    rank0_print(
